...
namespace MyLeagueTracker.Domain.Common
{
	...
	public abstract class ObjectBase
	{
		...
		{
			ObjectBase compareTo = obj as ObjectBase;
		...
		/// </summary>
		public virtual bool HasSameObjectSignatureAs(ObjectBase compareTo)
		{
			IEnumerable<PropertyInfo> signatureProperties = GetSignatureProperties();
		...
		public static bool operator ==(ObjectBase object1, ObjectBase object2)
		{
